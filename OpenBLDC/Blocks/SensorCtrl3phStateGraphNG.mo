...
block SensorCtrl3phStateGraphNG "Commutation applying PWM"
  ...
  PulseLogic pulseLogic(PwmVarFrequency=false)
  ...
  Modelica.Blocks.Sources.BooleanStep switchOn(startTime=0.1e-5)
  ...
  PhaseDiffVoltageNph phaseDiffVoltageNph
