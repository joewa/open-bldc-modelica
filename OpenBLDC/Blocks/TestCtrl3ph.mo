...
equation
  ...
  connect(halfBridgeCtrl_c.hCtrl, hCtrl[3]) annotation(Line(points={{60,-54},{
          76,-54},{76,66.6667},{100,66.6667}},                                                                              color = {255, 0, 255}, smooth = Smooth.None));
  ...
  connect(halfBridgeCtrl_c.lCtrl, lCtrl[3]) annotation(Line(points={{60,-66},{
          76,-66},{76,-53.3333},{100,-53.3333}},                                                                              color = {255, 0, 255}, smooth = Smooth.None));
  connect(angle, combiTable1Ds.u) annotation(Line(points = {{-100, 0}, {-62, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(combiTable1Ds.y[1], halfBridgeCtrl_a.val) annotation(Line(points={{-39,
          -0.666667},{0,-0.666667},{0,50},{40,50}},                                                                 color = {0, 0, 127}, smooth = Smooth.None));
  connect(combiTable1Ds.y[2], halfBridgeCtrl_b.val) annotation(Line(points = {{-39, 0}, {40, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(combiTable1Ds.y[3], halfBridgeCtrl_c.val) annotation(Line(points={{-39,
          0.666667},{0,0.666667},{0,-60},{40,-60}},                                                                   color = {0, 0, 127}, smooth = Smooth.None));
