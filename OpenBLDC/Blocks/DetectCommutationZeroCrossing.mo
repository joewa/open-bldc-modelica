...
block DetectCommutationZeroCrossing "Detects sensorless when commutation is required by zero crossings"
  ...
  Modelica.Blocks.Continuous.FirstOrder filtV(T = 1e-006) "Filters the voltage to be able to differentiate it";
initial equation
  maxBEMF = 0;
  time2commutate = 1;
  time_zc = 0;
