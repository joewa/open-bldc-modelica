...
block CommutationCounter "Counts up angular position in BLDC sensorless control mode"
  extends Modelica.Blocks.Icons.Block;
  Real dir;
  // besser discrete machen? Wie dann mit phi?
  //  Real KV "Memory of motor KV";
  Modelica.Blocks.Interfaces.BooleanInput resetCounter "Reset counter with phi0" annotation(Placement(transformation(extent = {{-120,40},{-80,80}})));
  ...
  Modelica.Blocks.Interfaces.BooleanInput commutate "Pulse when commutation detected" annotation(Placement(transformation(extent = {{-20,-20},{20,20}}, rotation = 270, origin = {-40,100})));
  ...
  Modelica.Blocks.Interfaces.BooleanInput shutdown "Shutdown PWM and commutation" annotation(Placement(transformation(extent = {{-20,-20},{20,20}}, rotation = 270, origin = {40,100})));
