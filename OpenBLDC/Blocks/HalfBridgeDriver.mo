...
block HalfBridgeDriver "Half bridge driver, e.g. IR2184"
  ...
  Modelica.Blocks.Interfaces.BooleanInput pin_IN
    "Pulses from the PWM generator"                                              annotation(Placement(transformation(extent={{-120,40},
            {-80,80}})));
  Modelica.Blocks.Interfaces.BooleanInput pin_SD "Shutdown inverted"             annotation(Placement(transformation(extent={{-120,
            -80},{-80,-40}})));
equation
