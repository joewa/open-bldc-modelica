...
partial block DetectCommutationPartial "I/O ports for commutation detection algorithm"
  ...
  Modelica.Blocks.Interfaces.BooleanInput pulses "PWM signal" annotation(Placement(transformation(extent = {{-120,20},{-80,60}})));
  ...
  Modelica.Blocks.Interfaces.BooleanOutput speedOK(start = false) "Sufficient EMF for good commutation" annotation(Placement(transformation(extent = {{90,30},{110,50}})));
