...
model HallCalibrationOld "Constant speed demonstrate hall sensor commutation"
  ...
  Modelica.Mechanics.Rotational.Sources.ConstantSpeed constantSpeed(w_fixed=2*
        pi*100)                                                                            annotation(Placement(transformation(extent = {{-62,-32},{-42,-12}})));
