...
model SensorlessBLDC "Application of sensorless BLDC commutation"
  ...
  replaceable Modelica.Mechanics.Rotational.Sources.ConstantSpeed mechanicalLoad "Replaceable mechanical attachment" annotation(Placement(transformation(extent = {{-92,-26},{-72,-6}})));
  ...
  replaceable Blocks.SensorlessCtrl3phStateGraphNG sensorlessCtrl3phPWM "Replacable (sensorless) BLDC controller" annotation(Placement(transformation(extent = {{-158,-56},{-138,-36}})));
  replaceable Modelica.Blocks.Sources.Constant motorVoltageCommand(k = 0.85) "Replaceable motor voltage command" annotation(Placement(transformation(extent = {{-192,-32},{-172,-12}})));
