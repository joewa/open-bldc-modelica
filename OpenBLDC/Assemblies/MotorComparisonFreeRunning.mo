...
model MotorComparisonFreeRunning
  "Spinning motors connected to the inverters doing nothing"
  ...
  Modelica.Mechanics.Rotational.Sources.ConstantSpeed constantSpeed(w_fixed=
        4000*2*Modelica.Constants.pi/60)                                                   annotation(Placement(transformation(extent={{-20,-32},
            {0,-12}})));
  ...
  Modelica.Electrical.Analog.Sources.ConstantVoltage constantVoltage(V=10)
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-92,-150})));
  Converters.SwitchingIdeal.Inverter3ph inverter3ph_1(GoffSwitch=1e-6,
      GoffDiode=1e-6)
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  Converters.SwitchingIdeal.Inverter3ph inverter3ph_2(GoffSwitch=1e-6,
      GoffDiode=1e-6)
  ...
  Modelica.Blocks.Sources.Constant mode_b(k=0) "Fixed bridge mode"
...
end MotorComparisonFreeRunning;
