...
partial model Converter "Icon for an electrical converter model"
  annotation(Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100,-100},{100,100}}, grid = {1,1}), graphics={  Polygon(points = {{-90,-90},{90,-90},{90,90},{-90,-90}}, lineColor = {0,0,255}, fillColor = {210,210,210},
