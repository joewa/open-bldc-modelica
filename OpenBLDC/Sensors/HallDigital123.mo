...
model HallDigital123 "3 hall sensors"
  ...
  parameter Modelica.SIunits.Angle hall_angle[3] = {(1 / 2 - 2 / 3) * pi,(1 / 2 + 0) * pi,(1 / 2 + 2 / 3) * pi} "Hall sensor is mounted at this electrical angle and outputs true";
  parameter Real Ppz = 1 "Sensor pairs of poles";
  Modelica.Mechanics.Rotational.Components.IdealGear hallGear(ratio = Ppz) "Virtual gear to provide the pairs of poles property";
  ...
  Modelica.Mechanics.Rotational.Interfaces.Flange_a flange "Flange to be measured" annotation(Placement(transformation(extent = {{-110,-10},{-90,10}})));
