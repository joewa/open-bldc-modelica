...
equation
  ...
  connect(r_sense.plug_n,star_n.plug_p) annotation(Line(points = {{-42,-40},{-62,-40}}, color = {0,0,255}, smooth = Smooth.None));
  connect(r_sense.plug_p,inverter.plug_p) annotation(Line(points = {{-22,-40},{8,-40},{8,0},{0,0}}, color = {0,0,255}, smooth = Smooth.None));
