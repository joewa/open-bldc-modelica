...
model Inverter3ph "3-phase inverter (wrapper)"
  ...
  Modelica.Electrical.MultiPhase.Basic.Star star_n(m = m) annotation(Placement(transformation(extent={{-62,-50},
            {-82,-30}})));
...
public
  Modelica.Electrical.MultiPhase.Basic.Resistor r_sense(m=m, R=fill(13.6e3, m))
...
equation
  ...
  connect(star_n.plug_p,inverter.plugL) annotation(Line(points={{-62,-40},{-46,
          -40},{-46,-4},{-22,-4}},                                                                        color = {0,0,255}, smooth = Smooth.None));
  ...
  connect(voltageSensor.v,v_dc) annotation(Line(points={{-78,-16},{-54,-16},{
          -54,-80},{-100,-80}},                                                                      color = {0,0,127}, smooth = Smooth.None));
  ...
  connect(r_sense.plug_n, star_n.plug_p) annotation (Line(
      points={{-42,-40},{-62,-40}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(r_sense.plug_p, inverter.plug_p) annotation (Line(
      points={{-22,-40},{8,-40},{8,0},{0,0}},
      color={0,0,255},
      smooth=Smooth.None));
