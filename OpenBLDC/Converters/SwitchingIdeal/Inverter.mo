...
public
  Modelica.Electrical.MultiPhase.Sensors.VoltageSensor voltageSensor(m=m)
    "Output voltage sensor" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-60,-10})));
  Modelica.Blocks.Interfaces.RealOutput v[m] "Output voltage at plug_p"
  ...
  Modelica.Blocks.Interfaces.RealOutput i[m] "Output current at plug_p"
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={40,-100})));
equation
  ...
  connect(voltageSensor.plug_n, plugL) annotation (Line(
      points={{-60,-20},{-60,-40},{-100,-40}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(voltageSensor.v, v) annotation (Line(
      points={{-71,-10},{-76,-10},{-76,-60},{-40,-60},{-40,-100}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(swH.plug_n, currentSensor.plug_p) annotation (Line(
      points={{-20,10},{-20,0},{40,0}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(swL.plug_p, currentSensor.plug_p) annotation (Line(
      points={{-20,-10},{-20,0},{40,0}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(voltageSensor.plug_p, currentSensor.plug_p) annotation (Line(
      points={{-60,0},{40,0}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(currentSensor.plug_n, plug_p) annotation (Line(
      points={{60,0},{100,0}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(currentSensor.i, i) annotation (Line(
      points={{50,-11},{40,-11},{40,-100}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,  extent={{-100,
            -100},{100,100}}),                                                                          graphics), DymolaStoredErrors, Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
