...
model Inverter "Universal m-phase inverter"
  ...
  Modelica.Electrical.Polyphase.Ideal.IdealClosingSwitch swL(m = m, Ron = ronSwitch, Goff = goffSwitch) annotation(Placement(visible = true, transformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
...
equation
  connect(dL.plug_p, swL.plug_n) annotation(
    Line(points = {{-40, -30}, {-20, -30}}, color = {0, 0, 255}));
  connect(dL.plug_n, swL.plug_p) annotation(
  ...
  connect(ctrl_l, swL.control) annotation(
    Line(points = {{20, 106}, {20, -20}, {-8, -20}}, color = {255, 0, 255}));
  connect(plugH,swH.plug_p) annotation(Line(points = {{-100,40},{-60,40},{-60,30},{-20,30}}, color = {0,0,255}, smooth = Smooth.None));
  connect(plugL, swL.plug_n) annotation(
    Line(points = {{-100, -40}, {-60, -40}, {-60, -30}, {-20, -30}}, color = {0, 0, 255}));
  ...
  connect(swL.plug_p, currentSensor.plug_p) annotation(
    Line(points = {{-20, -10}, {-20, 0}, {40, 0}}, color = {0, 0, 255}));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics), DymolaStoredErrors, Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics={Text(lineColor = {0, 0, 255}, extent = {{-50, -60}, {-30, -90}}, textString = "v"),Text(lineColor = {0, 0, 255}, extent = {{30, -60}, {50, -90}}, textString = "i"),Text(lineColor = {0, 0, 255}, extent = {{-86, 50}, {-42, 30}}, textString = "plugH", fontSize = 36, horizontalAlignment = TextAlignment.Left),Text(lineColor = {0, 0, 255}, extent = {{-86, -28}, {-42, -48}}, textString = "plugL", fontSize = 36, horizontalAlignment = TextAlignment.Left),Text(lineColor = {0, 0, 255}, extent = {{24, 12}, {86, -8}}, textString = "plug_p", fontSize = 36, horizontalAlignment = TextAlignment.Right)}));
end Inverter;