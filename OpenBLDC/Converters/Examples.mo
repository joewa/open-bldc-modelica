...
model InvertersWithLoad
  ...
  Modelica.Blocks.Sources.Constant dutyCycle[3](each k = 0.7) annotation(
...
equation
  ...
  connect(halfBridgeLogicBLDCContinuous.hCtrl, inverterNph_cont.ctrl_h) annotation(
      Line(points = {{-40, 56}, {-2, 56}, {-2, 40}}, color = {0, 0, 127}, thickness = 0.5));
  connect(halfBridgeLogicBLDCContinuous.lCtrl, inverterNph_cont.ctrl_l) annotation(
      Line(points = {{-40, 44}, {2, 44}, {2, 40}}, color = {255, 0, 255}, thickness = 0.5));
  connect(dutyCycle.y, halfBridgeLogicBLDCContinuous.pulses) annotation(
      Line(points = {{-142, 48}, {-136, 48}, {-136, 58}, {-60, 58}}, color = {0, 0, 127}, thickness = 0.5));
  connect(multiplex3_1.y, halfBridgeLogicBLDCContinuous.val) annotation(
      Line(points = {{-76, -6}, {-72, -6}, {-72, 50}, {-60, 50}}, color = {0, 0, 127}, thickness = 0.5));
  connect(pwmMode.y, halfBridgeLogicBLDCContinuous.pwm_Mode) annotation(
      Line(points = {{-76, -24}, {-68, -24}, {-68, 42}, {-60, 42}}, color = {255, 127, 0}, thickness = 0.5));
