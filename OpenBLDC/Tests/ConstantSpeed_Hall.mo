...
model ConstantSpeed_Hall "Constant speed demonstrate hall sensor commutation"
  ...
  Sensors.HallDigital123 hallDigital123_1
    annotation (Placement(transformation(extent={{12,-38},{32,-18}})));
equation
  connect(smpm.flange, hallDigital123_1.flange) annotation (Line(
      points={{-16,-2},{-2,-2},{-2,-28},{12,-28}},
      color={0,0,0},
      smooth=Smooth.None));
