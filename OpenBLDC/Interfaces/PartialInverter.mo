...
public
  Modelica.Electrical.MultiPhase.Interfaces.PositivePlug plug_p(m=m)
    annotation (Placement(transformation(extent={{90,-10},{110,10}})));
  Modelica.Electrical.MultiPhase.Interfaces.PositivePlug plugH(m=m)
    annotation (Placement(transformation(extent={{-110,30},{-90,50}})));
  Modelica.Electrical.MultiPhase.Interfaces.NegativePlug plugL(m=m)
